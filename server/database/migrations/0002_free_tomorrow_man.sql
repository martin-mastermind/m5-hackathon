...
CREATE TABLE `__new_games` (
	...
	`played_at` integer DEFAULT '"2024-10-20T13:21:44.675Z"' NOT NULL,
...
CREATE TABLE `__new_user-claims` (
	...
	`claimed_at` integer DEFAULT '"2024-10-20T13:21:44.674Z"' NOT NULL,
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2024-10-20T13:21:44.674Z"' NOT NULL
);
--> statement-breakpoint
