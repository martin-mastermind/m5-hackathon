...
CREATE TABLE `__new_games` (
	...
	`played_at` integer DEFAULT '"2024-10-20T13:08:53.011Z"' NOT NULL,
...
CREATE TABLE `__new_user-claims` (
	...
	`claimed_at` integer DEFAULT '"2024-10-20T13:08:53.010Z"' NOT NULL,
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2024-10-20T13:08:53.010Z"' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_users`("id", "telegram_id", "avatar", "second_name", "first_name", "gas", "created_at") SELECT "id", "telegram_id", "avatar", "second_name", "first_name", "gas", "created_at" FROM `users`;--> statement-breakpoint
